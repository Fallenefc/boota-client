...
const Signup = () => {
  ...
  return (
    <div className="login-page">
      {alertModal ? (
        <AlertModal
          text="Failed to Sign up. Email most likely already exists"
          ...
          <div className="content-middle">
            ...
            <form className="login-form" onSubmit={handleSubmit}>
              ...
              {validationObj.email ? null : (
                <AlertText text="Email format is not valid" />
              )}
              <p>Password</p>
              <input
                type="password"
              ...
              {validationObj.password ? null : (
                <AlertText
                  text="Password must have between 6 and 18 characters"
                />
              )}
              ...
              <input
                ...
                value={passwordConf}
              />
              {validationObj.passwordConf ? null : (
              ...
              <input
                ...
                value={name}
              />
              {validationObj.name ? null : (
                <AlertText text="Name cannot be empty" />
              )}
